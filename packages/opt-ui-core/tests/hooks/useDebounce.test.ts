...
/**
 * Mocks the global setTimeout function using Jest's fake timers.
 * This function should be called before testing code that involves timers.
 */
...
/**
 * Mocks the global clearTimeout function using Jest's fake timers.
 * This function should be called before testing code that involves timers.
 */
